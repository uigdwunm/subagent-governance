...
class StateStoreModuleBoundaryTests(unittest.TestCase):
    ...
    def test_namespace_resolution_is_current_only_v12(self):
        ...
        self.assertEqual(installed, Path("/tmp/plugin-data/state-v12"))
        self.assertEqual(cache, Path("/tmp/codex/plugins/data/example-personal/state-v12").resolve())
