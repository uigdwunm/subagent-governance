...
class StateStoreModuleBoundaryTests(unittest.TestCase):
    ...
    def test_namespace_resolution_is_current_only_v11(self):
        ...
        self.assertEqual(installed, Path("/tmp/plugin-data/state-v11"))
        self.assertEqual(cache, Path("/tmp/codex/plugins/data/example-personal/state-v11").resolve())
